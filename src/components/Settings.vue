<template>
    <div class="settings">
        ...
        <Modal id="settings-color-modal" :visible="modals.colorPicker" title="Choose Your Flavor" @action="setBackgroundColor(); modals.colorPicker = false;" @cancel="modals.colorPicker = false">
        ...
        <Modal id="settings-reset-modal" :visible="modals.resetSettings" title="Reset All Data" @action="resetSettings" @cancel="modals.resetSettings = false">
